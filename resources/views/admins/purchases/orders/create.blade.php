...
<div class="row">
	<div class="col-12">
		<div class="card">
			...
			<!-- form start -->
			<form role="form" method="POST" action="{{ route('admin.purchases.orders.store') }}">
			@csrf
				<div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="datepicker" name="due_date" value="{{ old('due_date', now()->addWeek()->format('d-m-Y')) }}">
					...
					<table id="example1" class="table table-bordered">
						...
						<tbody>
                            ...
                            <tr>
                                <td>
                                    <select class="form-control select2" name="itemRows[item_id][]" style="width: 100%">
                                    <option value="">-- Pick One --</option>
                            ...
                            <tr>
                                ...
                                <td><input type="hidden" class="form-control" name="totalRows[item_total]">ITEM TOTAL</td>
                            </tr>
                            <tr>
                                <td colspan="3" style="text-align:right">{{ __('purchases.invoices.account_total') }} :</td>
                                <td><input type="hidden" class="form-control" name="totalRows[account_total]">ACCOUNT TOTAL</td>
                            </tr>
                            <tr>
                    ...
                    <table id="example1" class="table table-bordered mt-5">
						...
						<tbody>
                            ...
                            <tr>
                                <td>
                                    <select class="form-control select2" name="accountRows[vendor_id][]">
                                    <option value="">-- Pick One --</option>
                                    @foreach ($vendors as $id => $name)
                                        <option value="{{ $id }}">{{ $name }}</option>
                                    @endforeach
                                ...
                                <td>
                                    <select class="form-control select2" name="accountRows[account_id][]">
                                    <option value="">-- Pick One --</option>
                                ...
                                <td><input type="number" class="form-control" name="accountRows[amount][]"></td>
                                <td><input type="text" class="form-control" name="accountRows[memo][]"></td>
                            </tr>
                            @endfor
						</tbody>

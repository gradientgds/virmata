			...
			@method('PATCH')
				<div class="card-body">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="exampleInputPassword1" name="number" placeholder="Account Number" value="{{ old('number', $account->number) }}">
					</div>
					<div class="form-group">
						<label for="exampleInputEmail1">Account Name</label>
						<input type="text" class="form-control" id="exampleInputEmail1" name="name" placeholder="Account Name"  value="{{ old('name', $account->name) }}">
					</div>
					<div class="form-group">
						<label>Minimal</label>
